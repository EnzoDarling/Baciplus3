<?php
	...
	$result=mysql_query("SELECT * FROM muestra WHERE num_muestra LIKE '%".$_POST["search"]."%' ORDER BY num_muestra ASC",$con) or die ("Problemas al mostrar los datos:".mysql_error());
